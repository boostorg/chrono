  ...
  namespace chrono
  {
    ...
    public:
      ...
      T * get() BOOST_NOEXCEPT
      {
        register_once(index(), ios_);
        void* &pw = ios_.pword(index());
        if (pw == BOOST_CHRONO_NULLPTR)
        {
          return BOOST_CHRONO_NULLPTR;
        }
    ...
    public:
      ...
      base_type(ios)
      {
        if (this->get() == BOOST_CHRONO_NULLPTR)
        {
      ...
      {
        BOOST_ASSERT(new_value!=BOOST_CHRONO_NULLPTR);
